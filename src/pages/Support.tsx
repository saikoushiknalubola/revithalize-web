        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-gray-900 to-gray-800 border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <CardContent className="space-y-4">
              ...
              <button className="w-full mt-2 bg-gray-800 hover:bg-gray-700 text-white font-medium py-2 px-3 rounded-lg flex items-center justify-between group transition-all">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">+91-40-12345678</p>
                ...
                <div className="flex items-start">
                  <FileText className="mr-3 h-5 w-5 text-revithalize-green" />
                  <div>
                    <p className="text-white font-medium">Documentation</p>
                    <p className="text-gray-400 text-sm">Complete guides & tutorials</p>
                    <p className="text-gray-500 text-xs">Technical specifications & manuals</p>
                  </div>
                </div>
              </div>
