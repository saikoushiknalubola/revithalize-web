      ...
      >
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            Optimize charging costs and participate in sustainable energy sharing
          </p>
        </motion.header>
        ...
        >
          <div className="bg-gradient-to-br from-green-900/40 to-green-800/20 border border-green-600/20 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">Cost Savings</h3>
            <p className="text-gray-300 text-sm">
              Automatically charge during off-peak hours when electricity rates are lowest, 
              reducing your charging costs by up to 60%.
            </p>
          </div>
          
          <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 border border-blue-600/20 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">Renewable Energy</h3>
            <p className="text-gray-300 text-sm">
              Prioritize charging when renewable energy sources are abundant, 
              supporting a cleaner grid and reducing carbon emissions.
            </p>
          </div>
          
          <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border border-purple-600/20 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">Energy Trading</h3>
            <p className="text-gray-300 text-sm">
              Sell excess battery power back to the grid during peak demand periods 
              and earn credits toward your electricity bill.
            </p>
          </div>
        </motion.div>
      </motion.div>
