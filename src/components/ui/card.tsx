...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "min-w-0 relative rounded-2xl border border-border bg-card text-card-foreground shadow-card",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "min-w-0 font-sora text-lg sm:text-xl font-semibold leading-tight tracking-tight",
      className
    )}
    {...props}
  />
